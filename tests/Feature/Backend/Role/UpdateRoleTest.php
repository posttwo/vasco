...
class UpdateRoleTest extends TestCase
{
    ...
    public function an_admin_can_access_the_edit_role_page()
    {
        ...
        $this->get("/a/auth/role/{$role->id}/edit")->assertStatus(200);
    }
    ...
    public function name_is_required()
    {
        ...
        $response = $this->patch("/a/auth/role/{$role->id}", ['name' => '']);
    ...
    public function at_least_one_permission_is_required()
    {
        ...
        $response = $this->patch("/a/auth/role/{$role->id}", ['name' => 'new role']);
    ...
    public function a_role_name_can_be_updated()
    {
        ...
        $this->patch("/a/auth/role/{$role->id}", ['name' => 'new name', 'permissions' => ['view backend']]);
