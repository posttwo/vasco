...
class CreateRoleTest extends TestCase
{
    ...
    public function an_admin_can_access_the_create_role_page()
    {
        ...
        $this->get('/a/auth/role/create')->assertStatus(200);
    }
    ...
    public function the_name_is_required()
    {
        ...
        $response = $this->post('/a/auth/role', ['name' => '']);
    ...
    public function the_name_must_be_unique()
    {
        ...
        $response = $this->post('/a/auth/role', ['name' => config('access.users.admin_role')]);
    ...
    public function at_least_one_permission_is_required()
    {
        ...
        $response = $this->post('/a/auth/role', ['name' => 'new role']);
    ...
    public function a_role_can_be_created()
    {
        ...
        $this->post('/a/auth/role', ['name' => 'new role', 'permissions' => ['view backend']]);
